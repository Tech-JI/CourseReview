LayupList.Web.CourseDetail = function (courseId) {
  ...
  cd.upvote = function (courseId, element, forLayups) {
    com.vote(1, courseId, element, forLayups);
  };
  cd.downvote = function (courseId, element, forLayups) {
    com.vote(-1, courseId, element, forLayups);
  };
  ...
  $.getJSON("/api/course/" + courseId + "/medians", function (data) {
    ...
    svg
      ...
      .attr("y", function (d) {
        return y(d.avg_numeric_value);
      })
      .attr("height", function (d) {
        return height - y(d.avg_numeric_value);
      });
  });
};
